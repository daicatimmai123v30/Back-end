...
<body>
    ...
    <div class="content">
        <div class="product">
            <div class="img">
                <img src="https://rlv.zcache.com/watercolor_greenery_and_flowers_confirmation_invitation-r6544afba2fd04c65872b70883536b2d7_tcv4s_200.jpg" style="width: 150px;height:150px;"alt="">
            </div>
        </div>
    </div>
    <footer>
